...
public class DirectCarsDto {
    ...
    public DirectCars toEntity(){
        DirectCars build = DirectCars.builder()
                .id(id)
                .title(title)
                .filePath(filePath)
                .filePath2(filePath2)
    ...
    @Builder
    public DirectCarsDto(Long id, LocalDateTime createdDate, String title, String carsalecheck, String subcontent, String filePath, String filePath2, String filePath3, String filePath4, String filePath5, String filePath6, String filePath7, String filePath8, String filePath9, String filePath10, String filePath11, String filePath12, String filePath13, String filePath14, String filePath15, String filePath16, String filePath17, String filePath18, String filePath19, String filePath20, String content, String imgFullPath,
