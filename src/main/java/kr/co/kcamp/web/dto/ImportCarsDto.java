...
public class ImportCarsDto {
    ...
    public ImportCars toEntity(){
        ImportCars build = ImportCars.builder()
                .id(id)
                .title(title)
                .caryear(caryear)
